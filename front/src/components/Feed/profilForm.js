  ...
  return (
    <div className="flex justify-center items-center flex-col w-full border-2 border-solid border-primary rounded-2xl">
      ...
      <img
        ...
        alt="user-pic"
        className="p-4 rounded-full object-cover-fit h-44 w-44"
      />
      <div className="flex flex-col justify-center items-center py-4">
        ...
        {updateForm === false && (
          <>
            <p
              className="border-solid border-2 border-secondary h-20 w-60 p-2 rounded-xl"
              onClick={() => setUpdateForm(!updateForm)}
            >
              {userData.bio}
            </p>
            <button
              className="mt-4 bg-secondary px-6 py-4 rounded-full"
              onClick={() => setUpdateForm(!updateForm)}
            >
              Modifier bio
            </button>
        ...
        {updateForm && (
          <>
            <textarea
              className="bg-tertiary/25 text-black border-solid border-2 border-primary h-20 w-60 p-2 rounded-xl"
              type="text"
